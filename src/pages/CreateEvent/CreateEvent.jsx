  ...
  return (
    <div className="flex">
      <div>
        ...
        <div className="bg-[#F2F6FF] p-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {/* Left Content  */}
          <div>
            <div className="flex gap-3 items-center bg-white rounded-full overflow-hidden px-4 shadow-primary mt-5">
              <span className="flex items-center gap-2">
                ...
                <span className="text-[#1D1D1D] font-medium whitespace-nowrap">
                  Name of event
                </span>
              </span>
              <input
                type="text"
                className="w-full py-2 outline-none border-none text-[15px] focus:outline-none"
              />
            </div>
            ...
            <div className="my-10 relative">
              ...
              <div
                className="bg-white p-9 px-14 md:px-3 xl:px-14 rounded-3xl"
            ...
            <div className="flex gap-5 mt-5">
              <div className="w-full flex gap-3 items-center justify-between bg-white rounded-full overflow-hidden px-4 shadow-primary">
                <span className="block w-full text-[#1D1D1D] font-medium whitespace-nowrap">
                  Time start
                </span>
                <input
                  type="number"
                  className="max-w-[100px] w-full py-2 outline-none border-none text-[15px] text-[#1BB6ED]"
                />
              </div>

              <div className="w-full flex gap-3 items-center justify-between bg-white rounded-full overflow-hidden px-4 shadow-primary">
                <span className="flex items-center text-[#1D1D1D] font-medium whitespace-nowrap">
                  Hours
                </span>
                <input
                  type="number"
